...
void registrar(){
    ...
    recibirCumpleanios:
        ...
        system("cls");
        cout<<"Ingresa tu fecha de cumpleanios:"<<endl<<"dia: ";
        cin>>birthdateDay;
        cout<<endl<<"mes: ";
        cin>>birthdateMonth;
        cout<<endl<<"anio: ";
...
void escribirMensaje(const string usuarioRemitente){
    ...
    inicioEscribirMensaje:
        ...
        system("cls");
        cout<<"Ingrese el usuario del destinatario:"<<endl;
...
void aplicaciones(const string usuario){
    ...
    iniAplicaciones:
        system("cls");
        cout<<"Aplicaciones: "<<usuario<<endl;
...
void horoscopo(const string usuario){
    ...
    //cout<<fileName<<endl;
    leer.open(fileName.c_str(), ios::in);
    cout<<"Horoscopo: "<<usuario<<endl;
    for(int i=0;i<signo;i++){
        leer.getline(temp, 512);
    }
    cout<<'\t'<<signos[signo-1]<<endl<<temp<<endl;
    leer.close();
    getch();
}
...
void numeros(const string usuario){
    system("cls");
    cout<<"Numeros: "<<usuario<<endl<<endl;
    getch();
