...
void imprimir(char *msg=""){
    //cout<<"Imprimir -- "<<++contador<<" -- "<<msg<<endl;
    //system("pause");
}

int contarR(int dim, int c, int f, char **sopa, string cad, int *res){
...
int contarL(int dim, int c, int f, char **sopa, string cad, int *res){
    int cont = 0, i, j, k, pos, k1;
    imprimir();
    for (i=0;i<f;i++){
       for (j=0;j<c;j++){
...
int contarU(int dim, int c, int f, char **sopa, string cad, int *res){
    int cont = 0, i, j, k, pos, k1;
    imprimir();
    for (i=0;i<f;i++){
       for (j=0;j<c;j++){
...
int contarD(int dim, int c, int f, char **sopa, string cad, int *res){
    int cont = 0, i, j, k, pos, k1;
    imprimir();
    for (i=0;i<f;i++){
       for (j=0;j<c;j++){
...
int contarLD(int dim, int c, int f, char **sopa, string cad, int *res){
    int cont = 0, i, j, k, pos, k1;
    imprimir();
    for (i=0;i<f;i++){
       for (j=0;j<c;j++){
...
int contarRD(int dim, int c, int f, char **sopa, string cad, int *res){
    int cont = 0, i, j, k, pos, k1;
    imprimir();
    for (i=0;i<f;i++){
       for (j=0;j<c;j++){
...
int contarRU(int dim, int c, int f, char **sopa, string cad, int *res){
    int cont = 0, i, j, k, pos, k1;
    imprimir();
    for (i=0;i<f;i++){
       for (j=0;j<c;j++){
...
int contarLU(int dim, int c, int f, char **sopa, string cad, int *res){
    int cont = 0, i, j, k, pos, k1;
    imprimir();
    for (i=0;i<f;i++){
       for (j=0;j<c;j++){
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cont=contarR(dim, c, f, sopa, cad, res);
    cont+=contarL(dim, c, f, sopa, cad, res);
    cont+=contarU(dim, c, f, sopa, cad, res);
    cont+=contarD(dim, c, f, sopa, cad, res);
    cont+=contarRU(dim, c, f, sopa, cad, res);
    cont+=contarLU(dim, c, f, sopa, cad, res);
    cont+=contarRD(dim, c, f, sopa, cad, res);
    cont+=contarLD(dim, c, f, sopa, cad, res);
