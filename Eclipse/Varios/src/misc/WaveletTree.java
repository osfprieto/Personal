...
public class WaveletTree {
	...
	public String access(int i){//muestra el caracter en la posici�n i de la cadena
		if(alphabet.length()==2)
	...
	private int rank10(String a, int i){//muestra cu�ntas veces aparece a en la subcadena [1, i](1 o 0)
		int j;
		int cont = 0;
		for(j=0;j<i;j++)
	...
	public int rank(String a, int i){//muestra cu�ntas veces aparece a en la subcadena [1, i](1 o 0)
		if(alphabet.length()==2)
	...
	public int select(String a, int j){//muestra en qu� posici�n est� la j-�sima posici�n de a en la cadena
		if(alphabet.length()==2){
			char busqueda;
