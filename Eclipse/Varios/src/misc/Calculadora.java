...
public class Calculadora extends JFrame implements ActionListener{
	...
	public void numeroOprimido(int digito){
		...
		//System.out.println("bot�n "+digito+", bufferOperacion "+bufferOperacion);
	...
	private void operacionPulsado(String tecla) {
		...
		//System.out.println("bot�n "+tecla+", bufferOperacion "+bufferOperacion);
		//System.out.println(memoria+" "+resultado);
		
    }

	public void actionPerformed(ActionEvent e) {
		//System.out.println("Presi�n");
		try{
