 ...
 * Esta clase corre un JApplet en el que se pide un n�mero determinado por el usario de
...
public class TimeCounter extends JApplet implements ActionListener{
	    ...
	    public void updateUI(){
				...
				outLim = new JLabel("Tiempo l�mite: 0");
				cont.add(new JLabel(""));
				cont.add(outAct);
				cont.add(outLim);
				this.setContentPane(cont);
	    ...
	    public void cambiarTiempo(){
			...
			outLim.setText("Tiempo l�mite: "+limit);
			outAct.repaint();
			outLim.repaint();
	    }
