...
public class DatosElectricos extends JFrame implements ListSelectionListener, CaretListener{
	...
	public DatosElectricos(){
		...
		String datosET[] = {"Monofásico", "Bifásico o trifásico"};
		...
		listAplicacion = new JLabel("Aplicación");
		String[] datosAplicacion = {"Seco o húmedo", "Seco", "Muy húmedo", "Húmedo"};
	...
	private void actualizar(){
		//JOptionPane.showMessageDialog(null, "Algo cambió!", "Alerta", JOptionPane.INFORMATION_MESSAGE);
		//Código que hace las operaciones y asigna los valores
